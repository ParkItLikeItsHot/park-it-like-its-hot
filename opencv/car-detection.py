...
def run_car_detection():
    ...
    while True:
        ...
        for obj in tracked_objects:
            ...
            if abs(obj_center_x - tracking_line_x) < 20 and obj['frames_since_seen'] == 0 and not obj['crossed']:
                obj['crossed'] = True
        ...
        for obj in tracked_objects:
            ...
            if direction:
                cv2.putText(frame, direction, (x, y + h + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
